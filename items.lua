...
local items = {
    -- WEAPONS
    {
        ...
        rarity = 1/2,
        color = colors.blue,
        sprite = lg.newImage("Sprites/laser.png")
    },
    {
        id = "bomb",
        damage = 30,
        rarity = 1/12,
        color = colors.blue
        sprite = lg.newImage("Sprites/bomb.png")
    },
    -- HEALTH
    {
        id = "healing",
        ...
        rarity = 1/14,
        color = colors.green,
        sprite = lg.newImage("Sprites/heart.png")
    },
    -- BUFFS
    {
        id = "shield",
    ...
    -- TRAPS
    {
        ...
        rarity = 1/3,
        color = colors.red,
        sprite = lg.newImage("Sprites/skull.png")
    },
...
function items.drawGrid()
    ...
    for _, rowName in ipairs(rows) do
        ...
        for i = 1, 15 do
            ...
            if item and item.sprite and not items.usedTiles[ti] then
                love.graphics.draw(item.sprite, tile.x, tile.y, 0, 1.8, 1.8)
            elseif item and not item.sprite and not items.usedTiles[ti] then
                setColorOrDefault(item.color)
